    ...
    class BuddyPress_LearnDash_Admin {
	   ...
	   private function is_network_activated(){
        ...
        ?>
            <div class="wrap">
				...
				<form action="<?php echo $this->form_action; ?>" method="post">
					...
					<p class="submit">
						<input name="bp_learndash_settings_submit" type="submit" class="button-primary" value="<?php esc_attr_e('Save Changes'); ?>" />
					</p>
				</form>
            </div>
        ...
        public function courses_visibility_option(){
            ...
            _e( 'Display <em>Profile > Courses</em> content publicly', 'buddypress-learndash' );
        }
