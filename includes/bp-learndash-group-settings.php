		...
		function settings_screen( $group_id = NULL ) {
			...
			if ( !empty($courses) ) { ?>
				<div class="bp-learndash-group-course">
					<h4><?php _e('Group Course','buddypress-learndash'); ?></h4>
			...
			if ( !empty($group_status) && ( '-1' != $group_status )  ) {
				...
				<div class="bp-learndash-course-activity-checkbox">
					...
					<h4><?php _e('Course Activity','buddypress-learndash'); ?></h4>
					<p><?php _e('Which course activity should be displayed in this group?','buddypress-learndash'); ?></p><br/>
					<input type="checkbox" name="user_course_start" value="true" <?php echo $this->bp_is_checked( 'user_course_start', $bp_learndash_course_activity ); ?>><?php _e('User starts a course','buddypress-learndash'); ?><br>
					<input type="checkbox" name="user_course_end" value="true" <?php echo $this->bp_is_checked( 'user_course_end', $bp_learndash_course_activity ); ?> ><?php _e('User completes a course','buddypress-learndash'); ?><br>
					<input type="checkbox" name="user_lesson_start" value="true" <?php echo $this->bp_is_checked( 'user_lesson_start', $bp_learndash_course_activity ); ?> ><?php _e('User creates a lesson','buddypress-learndash'); ?><br>
					<input type="checkbox" name="user_lesson_end" value="true" <?php echo $this->bp_is_checked( 'user_lesson_end', $bp_learndash_course_activity ); ?> ><?php _e('User completes a lesson','buddypress-learndash'); ?><br>
